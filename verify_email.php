...
<?php else: ?>
  ...
  <form method="POST" id="verify-form">
    ...
    <div style="display:flex; gap:0.5rem; margin:1.5rem auto; justify-content:center;">
  <input type="text" name="d1" id="d1" maxlength="1" inputmode="numeric"
         style="width:3rem; height:3.5rem; font-size:1.8rem; text-align:center; border:2px solid #ccc; border-radius:12px;">
